...
from app.models import Staff,Staff_Notification,Staff_Leave,Staff_Feedback,Subject,Session_Year,Student,Attendance,Attendance_Report,StudentResult,Student,Course
...
def STAFF_SAVE_RESULT(request):
    if request.method == 'POST':
         ...
         if check_exists:
             ...
             result.assingment_mark = assignment_mark
             ...
             result = StudentResult(
                 ...
                 subject_id = get_subject,
                 exam_mark = Exam_mark,
                 assingment_mark = assignment_mark,
             )
             result.save()
