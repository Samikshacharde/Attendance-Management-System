...
urlpatterns = [
            ...
            #This is staff urls
                 ...
                 path("Staff/Leave/Save",Staff_Views.STAFF_APPLY_LEAVE_SAVE,name='staff_apply_leave_save'),
            ...
            #This is student urls
                 ...
                 path("Student/mark_as_done/<str:status>", Student_Views.NOTIFICATION_MARK_AS_DONE, name='notification_mark_as_done'),
                 ...
                 path("Student/Leave/Save",Student_Views.STUDENT_APPLY_LEAVE_SAVE,name='student_apply_leave_save'),
